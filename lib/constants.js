...
/** Interval in ms between two board scans (Arduino / micro:bit). */
const DETECTION_INTERVAL = 2000;

/** PWM duty cycle for pins.analog_pitch (0–1023). */
const PWM_DUTY_CYCLE = 512;

/** Strings present in micro:bit board details (USB volume). */
...
/** Code fragments used to detect MakeCode Python (vs standard MicroPython). */
...
/**
 * Regular expressions for MakeCode Python → MicroPython conversion.
 * Each key targets a pattern (basic.show_icon, input.on_button_pressed, etc.).
 */
